...
/**
 * @method static string renderIgniterToPdf(string $encryptedIgniterContent, ?array $recipient = null, ?string $encryptionKey = null, array $imageOverrides = [])
 ...
 * @method static string renderProjectToPdf(\Certigniter\CertificateRenderer\Data\CertificateProject $project, ?array $recipient = null, array $imageOverrides = [])
